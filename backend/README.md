...
## Project Structure
    ...
    ├── test_new_screen_dev_49693  # Django project configurations
...
1. Clone this repo and `cd test_new_screen_dev_49693`
...
2. Clone this repo and `cd test_new_screen_dev_49693`
